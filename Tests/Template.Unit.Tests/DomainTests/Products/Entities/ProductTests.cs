...
namespace Template.Unit.Tests.DomainTests.Products.Entities
{
    public class ProductTests
    {
        ...
        public void Should_Create_Product_With_Valid_Parameters()
        {
            ...
            // Act
            var product = new ProductEntity(name, price, barCode);
        ...
        {
            // Arrange
            var product = new ProductEntity("Product1", 10.0, "123456789");
